...
alert("submitted")
 ...
 function Move(){
  ...
  return (
    ...
    <h6 className='already' style={{color:"white"}}>Already a member?</h6>
      <p className='p-sign-in' onClick={Move}> Sign In</p>
    </div><br/>
...
<form onSubmit={sumbitHandle}>
  ...
  <input type="text" className="form-control" id="floatingInput"  placeholder="name" value={name} name='name' onChange={changeHandle} /><br/>
  <label for="floatingInput">name</label>
   </div>
    <div className="form-floating">
  <input type="text" className="form-control" id="floatingPassword" placeholder="usename" value={username} name='username' onChange={changeHandle}/><br/>
...
{/* <p>https://accounts.google.com/gsi/select?client_id=32073492121-s6ur8ti01mh34gq2bpbufb8ujdfrpn4v.apps.googleusercontent.com&ux_mode=redirect&login_uri=https%3A%2F%2Fdribbble.com%2Fauth%2Fgoogle_one_tap_signup%2Fcallback&ui_mode=card&as=f1vzxv6A5ibdqBPs9%2FJzSw&g_csrf_token=b759fba62d3c00ad</p> */}
